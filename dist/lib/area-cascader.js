...
var area_data_data = __webpack_require__(29);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-17792ff8","hasScoped":false,"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./components/area-cascader/cascader/index.vue
...
/* harmony default export */ var area_cascader = ({
    ...
    methods: {
        ...
        iterateCities: function iterateCities() {
            var temp = [];
            var provinces = this.iterate(data_default.a['86'], 0);
            ...
            for (var i = 0, l = provinces.length; i < l; i++) {
                ...
                item['children'] = this.iterate(data_default.a[provinces[i].value], 1);
                temp.push(item);
            }
        ...
        iterateAreas: function iterateAreas() {
            ...
            for (var i = 0, c = cities.length; i < c; i++) {
                ...
                for (var j = 0, l = city.children.length; j < l; j++) {
                    ...
                    var areas = this.iterate(data_default.a[city.children[j].value], 2);
                    // fix #7
                    if (areas.length) {
                        item['children'] = areas;
                    } else {
