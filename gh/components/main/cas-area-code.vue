<template>
    <div class="code-area">
        ...
        <div class="original-code" ref="original" v-if="shown">
            <pre><code><span>//返回值是一个数组，分别是省市的行政区域文本</span><br /><span>&lt;</span>template<span>&gt;</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;<span>&lt;</span>area-cascader&nbsp;type='all'&nbsp;v-model='selected'&gt;&lt;/area-cascader&gt;<br/>&lt;</span>/template<span>&gt;</span></code></pre>
        </div>
